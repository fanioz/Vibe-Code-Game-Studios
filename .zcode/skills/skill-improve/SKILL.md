...
Verify `.zcode/skills/[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `.zcode/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.zcode/skills/[name]/SKILL.md`?"
...
Write the improved skill to `.zcode/skills/[name]/SKILL.md`.
...
Ask: "May I revert `.zcode/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- .zcode/skills/[name]/SKILL.md`
